...
public class MainActivity extends BaseActivity
        implements NavigationView.OnNavigationItemSelectedListener, IBeerEventListener, IBeerListEventListener {

    BeerEventEmitter eventEmitter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, EditBeerActivity.class));
            }
        });
...
//        }
    ...
    @Override
    public void beerUpdated(Beer beer) {
        adapter.addBeer(beer);
    }

    @Override
    public void beerRemoved(Beer beer) {
        Log.v("Testing interface", (beer == null) + "");
    }

    @Override
    public void beerIdAdded(String beerId) {
        eventEmitter.addListener(beerId);
    }
